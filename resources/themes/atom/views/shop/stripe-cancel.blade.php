...
<head>
    ...
    <style>
        ...
        .x { width: 64px; height: 64px; margin: 0 auto 16px; border-radius: 50%; background: #6e7681; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 32px; font-weight: bold; }
