...
<input
    class="{{ $classes }} focus:ring-0 border-4 border-gray-200 rounded dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200 focus:border-[#d62a86] w-full @error($name, $errorBag) border-red-600 ring-red-500 @enderror"
